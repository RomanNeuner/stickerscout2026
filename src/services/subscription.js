...
const KEYS = {
  IS_PRO: '@stickerswap_is_pro',
  PRO_TS: '@stickerswap_pro_ts',
};

const PRO_CACHE_TTL = 24 * 60 * 60 * 1000; // 24 h

export const PRODUCT_IDS = {
  monthly: 'stickerswap_monthly_249',
  season: 'stickerswap_season_599',
};
...
export async function initRevenueCat() {
  try {
    ...
    // RevenueCat unavailable — cached status used
  }
}
